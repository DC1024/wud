Feature: WUD Container API Exposure
  ...
  Scenario Outline: WUD must handle different registry types and update patterns
    ...
    Examples:
      ...
      | 1     | ghcr.private   | ghcr_radarr              | https://ghcr.io/v2                                      | linuxserver/radarr           | 5.14.0.9383-ls245 | 6.4.4.10685-ls317 | true            | GHCR complex semver update   |
      | 3     | hub.public     | hub_alpine_latest        | https://registry-1.docker.io/v2                         | library/alpine               | latest            | latest            | false           | Hub latest tag no update     |
      | 4     | hub.public     | hub_homeassistant_202161 | https://registry-1.docker.io/v2                         | homeassistant/home-assistant | 2021.6.1          | 2026.9.3          | true            | Hub date-based versioning    |
      ...
      | 6     | lscr.private   | lscr_radarr              | https://lscr.io/v2                                      | linuxserver/radarr           | 5.14.0.9383-ls245 | 6.4.4.10685-ls317 | true            | LSCR complex semver update   |
  ...
  Scenario: WUD must generate correct links for containers with link templates
    ...
    And response body path $.result.link should be https://github.com/home-assistant/core/releases/tag/2026.9.3
